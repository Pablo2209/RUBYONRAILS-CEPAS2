...
class WinemakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create winemaker" do
    assert_difference('Winemaker.count') do
      post winemakers_url, params: { winemaker: { age: @winemaker.age, name: @winemaker.name, nationality: @winemaker.nationality, work: @winemaker.work } }
    end
  ...
  test "should update winemaker" do
    patch winemaker_url(@winemaker), params: { winemaker: { age: @winemaker.age, name: @winemaker.name, nationality: @winemaker.nationality, work: @winemaker.work } }
